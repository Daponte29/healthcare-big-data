...
try:
    from logistic_regression.lrsgd import LogisticRegressionSGD
    from logistic_regression.utils import parse_svm_light_data
except ImportError:
...
if __name__ == "__main__":
    ...
    parser.add_option(
        ...
        dest="path",
        default="model.txt",
        help="path where trained classifier will be saved",
    )
